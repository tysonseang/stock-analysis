...
The formatted 2017 and 2018 analysis can at the file titled VBA_Challenege.xlsm located [here](https://github.com/tysonseang/stock-analysis/blob/main/VBA_Challenge.xlsm). Pre- and post-refactoring code is shown below to showcase the updates. 
